...
<img src="/images/projects/tool-building1.png" alt="Mapping tool interface showing layered visualization" className="w-full rounded-lg my-8" />

<img src="/images/projects/tool-building2.png" alt="Mapping tool showing connections between layers" className="w-full rounded-lg my-8" />
...
<video
  src="/images/projects/layers-mapping.mp4"
  controls
  autoPlay
  loop
  muted

...
<img src="/images/projects/teamCollab2.png" alt="design system hub" className="w-full rounded-lg my-8" />
...
<img src="/images/projects/teamCollab1.png" alt="design system hub" className="w-full rounded-lg my-8" />
...
You can see it in my **Turning a CEO-Level Crisis into a New Way of Working** project, where we built a bridge with engineering to turn a C-suite crisis into a new, 50% faster workflow.

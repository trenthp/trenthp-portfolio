...
<img src="/images/projects/optavia_appStore.png" alt="screenshots from app store" className="w-full rounded-lg my-8" />
...
<img src="/images/projects/appScreens.png" alt="screenshots from app" className="w-full rounded-lg my-8" />
...
<table className="w-full border-collapse">
  ...
  <tbody>
    ...
    <tr className="border-b">
      <td className="py-3 px-4">Daily Active Users (DAU)</td>
